...
const Banjar = () => {
  ...
  return (
    <div
      className="pt-7 pb-5 px-0 sm:px-[70px] md:px-[120px] lg:px-[180px] xl:px-[240px] border-t-8 border-lightgreen"
    >
      ...
      /> */}
        ...
        <div
          className="flex flex-col justify-center xl:pl-10 w-full xl:pr-0 xl:w-1/2"
          data-aos="fade"
        >
          <div
            className="flex flex-col items-center justify-center p-[5px] mx-[32px] xl:mx-0 bg-gradient-to-tr from-darkgreen to-lightgreen mt-8 xl:mt-0"
            data-aos="fade-right"
          >
