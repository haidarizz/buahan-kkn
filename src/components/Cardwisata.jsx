...
const Cardwisata = () => {
  ...
  return (
    <div
      className="pt-7 pb-5 px-[32px] sm:px-[70px] md:px-[120px] lg:px-[180px] xl:px-[240px] z-20"
    >
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center mb-4 lg:mb-5 pt-7 lg:pt-10" data-aos='fade-down'>
        <div className="flex flex-col bg-gradient-to-tr from-darkgreen to-lightgreen w-full lg:w-1/2 mx-3 p-2 mb-4 lg:mb-0 shadow-lg shadow-green">
          <div className="bg-white w-full px-4 pt-4 pb-6">
            ...
            <h1 className="font-bold font-dmserif text-darkgreen text-xl mb-2">Potensi wisata A</h1>
            <p className="font-opensans mb-5">Lorem ipsum de amor fucking motherfucker</p>
            <a
              target="_blank"
        ...
        <div className="flex flex-col bg-gradient-to-tr from-darkgreen to-lightgreen w-full lg:w-1/2 mx-3 p-2 shadow-lg shadow-green">
          <div className="bg-white w-full px-4 pt-4 pb-6">
            <div className="overflow-hidden mb-4 shadow-sm">
              <img
                alt="img"
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center mb-4 lg:mb-4 mt-4 lg:mt-5"  data-aos='fade-down'>
        <div className="flex flex-col bg-gradient-to-tr from-darkgreen to-lightgreen w-full lg:w-1/2 mx-3 p-2 mb-4 lg:mb-0 shadow-lg shadow-green">
          <div className="bg-white w-full px-4 pt-4 pb-6">
            <div className="overflow-hidden mb-4 shadow-sm">
              <img
